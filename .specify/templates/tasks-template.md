...
- [ ] T010 [P] [US1] Unit test for [specific logic] in tests/unit/test_[name].py
...
**Checkpoint**: At this point, User Story 1 should be fully functional and verified by tests written in T010-T012.
